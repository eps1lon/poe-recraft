...
var grammar = {
    ...
    {"name": "Expression", "symbols": ["Skill"], "postprocess": ([skill]) => ({ type: 'skill',  ...skill })},
    ...
    {"name": "Skill", "symbols": ["SkillHead", "Newline", "SkillBody"], "postprocess": ([head, , body]) => ({ ...head, stats: body })},
    {"name": "SkillHead", "symbols": ["Identifier", "Whitespaces", "StringLiteral"], "postprocess": ([id, , start_file]) => ({ id, start_file })},
    {"name": "SkillBody$ebnf$1", "symbols": ["Whitespaces"], "postprocess": id},
    {"name": "SkillBody$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "SkillBody$ebnf$2", "symbols": ["Newline"], "postprocess": id},
    {"name": "SkillBody$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "SkillBody$ebnf$3", "symbols": ["FilterIdentifiers"], "postprocess": id},
    {"name": "SkillBody$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "SkillBody$ebnf$4", "symbols": ["Newline"], "postprocess": id},
    {"name": "SkillBody$ebnf$4", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "SkillBody", "symbols": [{"literal":"{"}, "SkillBody$ebnf$1", "SkillBody$ebnf$2", "SkillBody$ebnf$3", "SkillBody$ebnf$4", {"literal":"}"}], "postprocess": ([, , , ids]) => ids},
