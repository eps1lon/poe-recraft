...
var grammar = {
    ...
    {"name": "TranslationMatcher", "symbols": ["Matcher", "Whitespaces", "StringLiteral", "OptionalFormatters", "TranslationMatcher$ebnf$1"], "postprocess": ([matcher, , text, formatters]) => ({ matcher, text, formatters})},
