...
var grammar = {
    ...
    {"name": "main$ebnf$2", "symbols": ["main$ebnf$2", "NoDescription"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "main$ebnf$3", "symbols": []},
    {"name": "main$ebnf$3", "symbols": ["main$ebnf$3", "Description"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "main", "symbols": ["main$ebnf$1", "main$ebnf$2", "main$ebnf$3"], "postprocess": ([, no_desc, desc]) => (desc)},
    ...
    {"name": "DescriptionHeader$ebnf$2", "symbols": ["StatIdentifier"], "postprocess": id},
    {"name": "DescriptionHeader$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "DescriptionHeader", "symbols": ["DescriptionHeader$string$1", "DescriptionHeader$ebnf$1", "DescriptionHeader$ebnf$2", "Newline"], "postprocess": ([, ident]) => ident ? ident[1] : null},
    ...
    {"name": "Stats", "symbols": ["Whitespaces", "IndexNumber", "Whitespaces", "StatIdentifiers", "Newline"], "postprocess": ([, , , identifiers]) => identifiers},
