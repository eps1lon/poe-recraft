...
var grammar = {
    ...
    {"name": "main$ebnf$2", "symbols": ["main$ebnf$2", "Include"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "main$ebnf$3", "symbols": ["HasIdentifiers"], "postprocess": id},
    {"name": "main$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "main$ebnf$4", "symbols": []},
    {"name": "main$ebnf$4", "symbols": ["main$ebnf$4", "NoDescription"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "main$ebnf$5", "symbols": []},
    {"name": "main$ebnf$5", "symbols": ["main$ebnf$5", "Description"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "main", "symbols": ["main$ebnf$1", "main$ebnf$2", "main$ebnf$3", "main$ebnf$4", "main$ebnf$5"], "postprocess": ([, includes, has_identifiers, no_desc, desc]) => ({ includes, has_identifiers, no_desc, desc })},
    ...
    {"name": "Include$ebnf$1", "symbols": ["Newline"]},
    {"name": "Include$ebnf$1", "symbols": ["Include$ebnf$1", "Newline"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "Include", "symbols": ["Include$string$1", "StringLiteral", "Include$ebnf$1"], "postprocess": ([, include]) => include},
    ...
    {"name": "HasIdentifiers$ebnf$1", "symbols": ["Newline"]},
    {"name": "HasIdentifiers$ebnf$1", "symbols": ["HasIdentifiers$ebnf$1", "Newline"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "HasIdentifiers", "symbols": ["HasIdentifiers$subexpression$1", "HasIdentifiers$ebnf$1"], "postprocess": ([directive]) => directive === 'has_identifiers'},
    ...
    {"name": "DescriptionHeader$ebnf$4", "symbols": ["Newline"]},
    {"name": "DescriptionHeader$ebnf$4", "symbols": ["DescriptionHeader$ebnf$4", "Newline"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "DescriptionHeader", "symbols": ["DescriptionHeader$ebnf$1", "DescriptionHeader$string$1", "DescriptionHeader$ebnf$2", "DescriptionHeader$ebnf$3", "DescriptionHeader$ebnf$4"], "postprocess": ([, , , ident]) => ident ? ident[1] : null},
